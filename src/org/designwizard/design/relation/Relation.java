...
public class Relation {
	...
	public enum TypesOfRelation {
		...
		public TypesOfRelation getReverseRelation() {
			...
			} else if (this.equals(TypesOfRelation.MODULE_OF)) {
				return ENTITY_OF;
			}
			return null;
		}
		...
		public static TypesOfRelation extractElement(String type) throws InexistentTypeOfRelationException {
	        ...
	        }  else if ((type.equals("MODULE_OF"))) {
	         return TypesOfRelation.MODULE_OF;
	        }  else if ((type.equals("ENTITY_OF"))) {
		     return TypesOfRelation.ENTITY_OF;
		    }
