...
public class DesignManager implements ExtractionListener {
	...
	public void moduleExtracted(FactEvent event) {
		this.design.moduleExtracted(event.getEntity());
	}
	...
	public Set<ModuleNode> getAllModules() {
		return this.design.getAllModulesFromCode();
	}
	...
	public ModuleNode getModule(String fullyQualifiedNameModule) throws InexistentEntityException {
		return this.design.getModule(fullyQualifiedNameModule);
	}
